            ...
            <div class="bg-white rounded-lg p-[24px] grid gap-[16px]">
                ...
                <div class="pt-[16px]">
                    ...
                    <div class="grid grid-cols-1 items-center justify-between">
                        <div class="grid grid-cols-1 items-center justify-between">
                            <button onclick="signup()" type="button" id="signup_button"
                                class="w-full flex items-center justify-center py-[8px] bg-green-400 rounded-[10px] text-[16px] font-bold text-white">
                                ثبت نام
                            </button>
                        </div>

                        <div id="message_form_signup"
                            class="relative z-0 group grid grid-cols-1 gap-[16px] mb-7"></div>
                        </div>


                        <div class="grid grid-cols-1 items-center justify-between">
                            <a href="./login.php">حساب کاربری دارید؟  ورود</a>
                        </div>
